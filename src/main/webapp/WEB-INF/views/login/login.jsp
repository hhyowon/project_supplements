        ...
        <div class="row justify-content-center">
          <div class="col-md-4">
            <div  style="border-radius: 8px; background-color: white; margin-top: 50px;">
              ...
              <form action="/main" style="margin-top: 20px;">
                <div class="form-group" style="margin-bottom: 15px;">
                  <input class="form-control" type="text" name="id" placeholder="아이디를 입력하세요" id="idid">
                </div>
                <div class="form-group" style="margin-bottom: 15px;">
                ...
                <div class="text-center" style="margin-top: 20px;">
                  <a href="/signup" class="btn btn-main">회원가입</a>
