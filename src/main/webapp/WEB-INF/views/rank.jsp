            ...
            <tbody>
                <tr class="text-center">
                    ...
                    <td rowspan='3' style="background-color: #dbedff;">
                        <div class="row">
                            <div class="col-4"> <img src=/html/img/supplement1.png alt width="250" height="300"></div>
                            <div class="col-4"> <img src=/html/img/supplement2.jpg alt width="250" height="300"></div>
                            <div class="col-4"> <img src=/html/img/supplement3.png alt width="250" height="300"></div>
                        </div>
                    </td>
