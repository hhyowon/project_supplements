    ...
    <form  method= "get" action="/survey/survey_no" >
        ...
        <div class="container bg-white fs-6 py-6 row mx-auto my-3">
            <div class="text-center d-flex justify-content-center py-2">
                ...
                <button type="submit" formaction="/survey/insertAndSelectSurvey" class="btn btn-white btn-outline-dark" style="background-color: #5B9BD5; color: white; border-color: transparent;">설문제출</button>
            </div>
        </div>
    </form>
