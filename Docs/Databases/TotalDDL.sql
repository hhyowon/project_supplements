...
CREATE TABLE BMI
(
  BMI_UID    VARCHAR(50) NOT NULL COMMENT 'BMI_UID',
  USER_ID    VARCHAR(50) NOT NULL COMMENT '회원아이디',
  GENDER_UID VARCHAR(50) NOT NULL COMMENT '성별_UID',
  DATE       VARCHAR(50) NOT NULL COMMENT '날짜',
  HEIGHT     NUMERIC(10, 2) NOT NULL COMMENT '신장', -- NUMERIC(전체자리수, 소수점자리수)
  WEIGHT     NUMERIC(10, 2) NOT NULL COMMENT '체중',
  BMI_RESULT NUMERIC(10, 2) NOT NULL COMMENT 'BMI 결과값', 
  BMI_TYPE   VARCHAR(50) NOT NULL COMMENT 'BMI_타입',
  PRIMARY KEY (BMI_UID)
);
